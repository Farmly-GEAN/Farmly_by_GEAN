...
<head>
    ...
    <style>
        ...
        /* Status Badges */
        .status { padding: 5px 10px; border-radius: 15px; font-size: 0.8rem; font-weight: bold; display: inline-block; }
            ...
            <tbody>
                <?php if (!empty($orders)): ?>
                    ...
                    <?php 
                        ...
                        $o_status = $o['Status'] ?? $o['status'] ?? $o['Order_Status'] ?? $o['order_status'] ?? 'Pending';

                        $b_name = $o['Buyer_Name'] ?? $o['buyer_name'] ?? 'Unknown Buyer';
                    ...
                    <tr>
                        ...
                        <td>$<?php echo htmlspecialchars(number_format((float)$o_amount, 2)); ?></td>
