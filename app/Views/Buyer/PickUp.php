...
<head>
    ...
    <style>
        ...
        .location-box h4 { margin: 0 0 5px 0; font-size: 1.1rem; }
        .location-box p { margin: 0; font-size: 0.95rem; }
...
<body>
    ...
    <header class="site-header">
        ...
        <div class="header-center">Schedule Pickup</div>
        ...
        <form action="index.php?page=place_order" method="POST">
            ...
            <div class="form-group" style="display: flex; gap: 20px;">
                ...
                <div style="flex: 1;">
                    ...
                    <input type="time" name="pickup_time" class="form-input" required>
                </div>
            </div>

            <div class="form-group">
                <label>Note (Optional)</label>
                <input type="text" name="pickup_note" class="form-input" placeholder="I will arrive in a blue car...">
            </div>
