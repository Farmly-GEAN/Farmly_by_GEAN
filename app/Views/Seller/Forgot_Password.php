...
<body>
    <div class="fp-page">
        ...
        <form class="fp-form" action="index.php?page=seller_reset_action" method="POST">
            <h2 class="fpform-heading">Seller Password Reset</h2>
            ...
            <div class="button-container">
                ...
                <a href="index.php?page=seller_login" class="fpcancel-button" style="text-align:center; text-decoration:none; display:inline-block; line-height:1.5;">Cancel</a>
            </div>
        </form>
    </div>
