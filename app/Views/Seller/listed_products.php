            ...
            <table>
                ...
                <tbody>
                    <?php if (!empty($products)): ?>
                        ...
                        <tr>
                            <td>
                                <img src="<?php echo htmlspecialchars($p['product_image']); ?>" width="50" style="border-radius:5px;" onerror="this.src='assets/images/default.png';">
                            </td>
                        ...
                        <?php endforeach; ?>
                    <?php else: ?>
                        <tr><td colspan="5" style="text-align:center;">No products listed yet.</td></tr>
                    <?php endif; ?>
                </tbody>
            </table>
        </main>
